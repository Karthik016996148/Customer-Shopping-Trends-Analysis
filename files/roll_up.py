...
style = ttk.Style()
style.theme_use("default")
style.configure("Treeview", background="#917FB3", fieldbackground="#917FB3", foreground="black", font=('Arial', 10))
style.configure("Treeview.Heading", background="#917FB3", fieldbackground="#917FB3", foreground="black", font=('Arial', 12))
style.map("Treeview", background=[("selected", "#E5BEEC")])
