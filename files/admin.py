...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(activebackground="#cf1e13")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.message.configure(foreground="#cf1e13")
        ...
        self.button2.configure(activebackground="#cf1e13")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="white")
        self.button2.configure(background="#cf1e13")
        ...
        self.button3.configure(activebackground="#cf1e13")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="white")
        self.button3.configure(background="#cf1e13")
        ...
        self.button4.configure(activebackground="#cf1e13")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="white")
        self.button4.configure(background="#cf1e13")
        ...
        self.button5.configure(activebackground="#cf1e13")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="white")
        self.button5.configure(background="#cf1e13")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.tree.heading("Product ID", text="Item ID", anchor=W)
        self.tree.heading("Name", text="Item Name", anchor=W)
        self.tree.heading("Category", text="Category", anchor=W)
        self.tree.heading("Sub-Category", text="Size", anchor=W)
        self.tree.heading("In Stock", text="Color", anchor=W)
        self.tree.heading("MRP", text="Price", anchor=W)
