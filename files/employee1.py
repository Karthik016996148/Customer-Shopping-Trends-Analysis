...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(foreground="#cf1e13")
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.message.configure(background="#cf1e13")
        ...
        self.clock.configure(background="#cf1e13")
        ...
        self.button2.configure(foreground="#cf1e13")
        ...
        self.button3.configure(foreground="#cf1e13")
        ...
        self.button4.configure(foreground="#cf1e13")
        ...
        self.button5.configure(foreground="#cf1e13")
        ...
        self.button6.configure(foreground="#cf1e13")
        ...
        self.button7.configure(foreground="#cf1e13")
        ...
        self.button8.configure(foreground="#cf1e13")
        ...
        self.button9.configure(foreground="#cf1e13")
        ...
        find_category = "SELECT Category FROM Items"
    ...
    def get_category(self, Event):
        ...
        self.combo2.set('')
        self.combo3.set('')
        find_subcat = "SELECT ItemName FROM Items"
        cur.execute(find_subcat)
    ...
    def get_subcat(self, Event):
        ...
        self.combo3.set('')
        find_product = "SELECT Color from ItemDetails "
    ...
    def wel_bill(self):
        ...
        self.name_message.configure(background="#cf1e13")
        ...
        self.num_message.configure(background="#cf1e13")
        ...
        self.bill_message.configure(background="#cf1e13")
        ...
        self.bill_date_message.configure(background="#cf1e13")
        ...
        if self.state == 1:
            ...
            if(cust_name.get()==""):
                ...
                if strr.find('Total')==-1:
                    ...
                    self.entry1.configure(state="disabled", disabledbackground="#cf1e13", disabledforeground="#000000")
                    self.entry2.configure(state="disabled", disabledbackground="#cf1e13", disabledforeground="#000000")
                    self.state = 0
        else:
            return
    ...
    def clear_selection(self):
        ...
        self.entry4.configure(state="disabled")
        try:
            self.qty_label.configure(foreground="#cf1e13")
